...
import { LogOut, Calendar, Upload, Settings, Image as ImageIcon, Briefcase, Network, Menu, X, Bot } from 'lucide-react';
...
const navItems = [
  ...
  { name: 'Channex Manager', href: createPageUrl('ChannexDashboard'), icon: Network },
