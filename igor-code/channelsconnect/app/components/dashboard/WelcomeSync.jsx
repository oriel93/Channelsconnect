...
export default function WelcomeSync({ onSyncComplete, user: initialUser }) {
  ...
  const handleSync = async () => {
    setIsSyncing(true);
    toast.info("Starting property sync. This may take a few minutes... This may take a few minutes...");
      ...
      <Card className="max-w-xl w-full text-center">
        ...
        <CardContent className="space-y-6">
          ...
          <p className="text-slate-500">
            Click the button below to perform the initial sync with Channels Connect. This will pull in all the properties that have been imported from Airbnb.
          </p>
