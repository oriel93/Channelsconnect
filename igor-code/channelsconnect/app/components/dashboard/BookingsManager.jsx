  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (editBooking) {
        ...
        toast.success('Booking updated — syncing availability to Channex…');
      } else {
        await api.post('/bookings', payload);
        toast.success('Booking created — syncing availability to Channex…');
      }
      onSaved();
      onClose();
    } catch (err) {
    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-lg">
        ...
        <div className="flex items-center gap-2 text-xs text-blue-600 bg-blue-50 p-2 rounded-md">
          ...
          Saving will automatically update availability in Channex for the booked dates.
        </div>
    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-sm">
        ...
        <p className="text-sm text-gray-600">
          ...
          <br />
          <br />
          The blocked dates will be re-opened in Channex automatically.
        </p>
        <DialogFooter>
...
export default function BookingsManager({ listingId }) {
  ...
  const handleFullSync = async () => {
    ...
    try {
      ...
      toast.success('Full sync started — Channex is being updated with all ARI data.');
    } catch (err) {
      const msg =
    ...
    <div className="space-y-4 p-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">
            ...
            availability syncs automatically to Channex on every change.
          </p>
        </div>
      ...
      {fullSyncResult && (
        ...
        >
          ...
          <AlertDescription>
            {fullSyncResult.ok
              ? `Full sync in progress (log #${fullSyncResult.syncLogId ?? '—'}). Channex will be updated with 500-day ARI for all properties.`
              : fullSyncResult.msg}
          </AlertDescription>
        </Alert>
      )}
