...
import { Copy, Zap, CheckCircle2, AlertCircle, Loader2, ChevronRight, Clock, Bot as BotIcon } from 'lucide-react';
...
export default function MessageBubble({ message }) {
    ...
    return (
        <div className={cn("flex gap-3 my-2", isUser ? "justify-end" : "justify-start")}>
            {!isUser && (
                <div className="w-8 h-8 rounded-full overflow-hidden border-2 border-blue-600 mt-0.5 flex-shrink-0">
                    <img 
