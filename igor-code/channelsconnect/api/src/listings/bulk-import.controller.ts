...
export class BulkImportController {
  ...
  @Public()
  @ApiOperation({ summary: 'Download the Channels Connect onboarding template (.xlsx)' })
  downloadTemplate(@Res() res: Response) {
    const path = require('path');
    const fs   = require('fs');
    const templatePath = path.join(__dirname, 'onboarding-template.xlsx');
    ...
    res.setHeader('Content-Disposition', 'attachment; filename="ChannelsConnect_Onboarding_Form.xlsx"');
